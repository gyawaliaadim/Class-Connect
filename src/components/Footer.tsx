...
const Footer = () => {
    return (
        <footer className="flex bg-white dark:bg-black text-black dark:text-white mt-5  border-t-gray-700 border-t-2">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-black dark:text-white sm:text-center">© 2025 <Link href="#" className="hover:underline">Class Connect</Link>. All Rights Reserved.
                    </span>
